...
public class _4_Median_of_Two_Sorted_Arrays {
     ...
     *  最好是先画好图。上面的这些点其实在解的过程中都零零散散的想到的了，但是没有一种方法把这些串起来。
     *  想到和清晰地想清楚，实在是差太多了。
     *
     ...
     *
     *  因为我们用了一次递归，保证A的长度是小于等于B的，这意味着m只需要自己就可能凑够所有的左边，
     *  这就保证了A的取值范围可以是0～n， 虽然有两个变量i ， j， 但是j可以通过i确定，
     *  所以我们实际上就把这个问题转化为了关于i的二分查找， 数组A为left part贡献多少个元素。
     *  其中二分查找的判断条件是基于i 和 j的。
     *
     */
